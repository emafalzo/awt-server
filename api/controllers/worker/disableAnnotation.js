                                  ...
                                  Repositories.Users.find({_id : req.params.id_worker, type :'worker'}, function(result) {
                                      ...
                                      if (result.success){
                                          ...
                                          if (result.users.length > 0){
                                              ...
                                              Repositories.Tasks.find({ _id_campaign: req.params.id_campaign, _id_worker: req.params.id_worker, type: 'annotation' }, function(result) {

                                                  if (result.success){

                                                      if (result.tasks.length > 0){

                                                          Repositories.Tasks.delete({ _id_campaign: req.params.id_campaign, _id_worker: req.params.id_worker, type: 'annotation' }, function(result) {
