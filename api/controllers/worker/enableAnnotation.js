                                  ...
                                  Repositories.Users.find({_id : req.params.id_worker, type :'worker'}, function(result) {
                                      ...
                                      if (result.success){
                                          ...
                                          if (result.users.length > 0){
                                              ...
                                              Repositories.Tasks.find({_id_worker : req.params.id_worker, _id_campaign : req.params.id_campaign, type: 'annotation' }, function(result) {

                                                  if (result.success){

                                                      if (result.tasks.length > 0){
                                                          res.status(412).json({error : 'Worker already enabled!'});
                                                      } else {
                                                          ...
                                                          Repositories.Tasks.save(new_task, function(result) {
